...
| 이름 | 역할 | 담당 업무 상세 |
|:---:|:---:|---|
| **정진호 (팀장)** | **Translation & Demo** | • GPT-4o 기반 번역 프롬프트 설계 및 파이프라인 구축<br>• 웹 기반 시연 시스템 메인 개발 |
| **서동휘** | **PM & Presentation** | • 프로젝트 전체 일정 및 이슈 관리<br>• 논문 작성 총괄 및 투고 관리<br>• 최종 발표 자료 제작 및 발표 진행 |
| **고 운** | **Filtering & Evaluation** | • MACE 기반 오디오-텍스트 필터링 모듈 개발 및 임계값 실험<br>• 최종 벤치마크 모델 평가 실험 및 분석 |
